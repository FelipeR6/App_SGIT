...
router.post('/', async (req, res) => {
  try {
    ...
    const result = await db.query('INSERT INTO prestamo_equipo SET ?', [nuevoPrestamo]);
...
router.put('/:id', async (req, res) => {
  try {
    ...
    const result = await db.query('UPDATE prestamo_equipo SET ? WHERE Id_Prestamo_Equipo = ?', [prestamoActualizado, id]);
