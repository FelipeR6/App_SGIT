...
router.post('/', async (req, res) => {
  try {
    ...
    const result = await db.query('INSERT INTO mantenimiento SET ?', [nuevoMantenimiento]);
...
router.put('/:id', async (req, res) => {
  try {
    ...
    const result = await db.query('UPDATE mantenimiento SET ? WHERE Id_Mantenimiento = ?', [mantenimientoActualizado, id]);
